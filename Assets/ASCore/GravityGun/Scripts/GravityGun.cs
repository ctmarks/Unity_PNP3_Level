...
public class GravityGun : MonoBehaviour 
{
    ...
    void ApplyPushTo(GameObject _obj)
    {
        ...
        if (body)
        {
            ...
            Vector3 force = dirNorm * m_pushForceMag;
    ...
    void OnTriggerEnter(Collider _other)
    {
        ...
        DebugColor(_other.gameObject, Color.red);
    }
    ...
    void OnTriggerExit(Collider _other)
    {
        ...
        DebugColor(_other.gameObject, Color.green);
    ...
    void DebugColor(GameObject _obj, Color _color)
    {
        if (m_bDebugColor && IsInList(_obj))
        {
            Renderer theRenderer = _obj.GetComponent<Renderer>();
            if (theRenderer != null)
            {
                theRenderer.material.color = _color;
            }
        }
    }
}
