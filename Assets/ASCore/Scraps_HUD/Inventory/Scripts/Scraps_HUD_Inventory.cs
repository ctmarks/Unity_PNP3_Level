...
public class Scraps_HUD_Inventory : MonoBehaviour {
    ...
    private Vector2 itemPadding = new Vector2(0, 5);
    private Vector2 tailPadding = new Vector2(0, 5);
    ...
    private void DrawHeader(ref Vector2 _startPos, Vector2 _offset)
    {
        ...
        // Label (text)
        {
            Rect labelRect = new Rect(_startPos.x, _startPos.y, HeaderTexture.width, HeaderTexture.height);   
    ...
    private void DrawEntry(PickupInfo _pickup, ref Vector2 _startPos, Vector2 _offset, bool isLast)
    {
        ...
        // Is maxed out?
        Color colorTexture = (_pickup.count < _pickup.countMax ? Color.yellow : Color.green);
